...
<%  Assamese_String=""
	...
	<% eng_str=LCase(Request.QueryString("eng_text")+" ;")
...
if StrComp(elm,"i")=0  or StrComp(elm,"myself")=0 or StrComp(elm,"my")=0 Then
	...
	Response.Write ("<br>")
        ...
        Response.Redirect ("https://www.aanaadtu.com/EngSound.aspx?Org="+Request.QueryString("eng_text")+"&TL="+ThirdStringValued+"&Utch="+ThirdStringValuedUtcharan+"&Voice="+AddressString+"&User="+CStr(usernumber))
	...
	%>
	 ...
	 function tell1()
	 {
	   utter.voice=speechSynthesis.getVoices()[9]  ;
	   txt=""
	   txt=getCookie("AsStrUtchnew")+" "+getCookie("QHStrUtchnew")
				for (var i=0;i<200;i++)
				{
				  txt=txt.replace("+"," ");
				}
